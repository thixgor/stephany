...
export default function ClienteLayout({ children }: { children: React.ReactNode }) {
    ...
    const navigation = [
        { name: 'Minha Área', href: '/cliente', icon: FiHome },
        { name: 'Meus Pets', href: '/cliente/pets', icon: FaPaw },
        { name: 'Atendimentos', href: '/cliente/atendimentos', icon: FiCalendar },
        { name: 'Laudos e Exames', href: '/cliente/laudos', icon: FiFileText },
        { name: 'Meu Perfil', href: '/cliente/perfil', icon: FiSettings },
    ];
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="hidden lg:block">
                            <p className="text-sm font-semibold text-[#00231F]">{session?.user?.name || 'Cliente'}</p>
